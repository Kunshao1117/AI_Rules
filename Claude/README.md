...
4. **技能重複維護** — 兩個 AI 的技能各自維護 → 41 套操作型技能與 Gemini 版完全同步
...
graph TB
    ...
    subgraph ".claude/ 生態系統（部署後）"
        ...
        SKILLS[".claude/skills/<br/>41 套操作型技能"]
    end
...
| **操作型技能** | `.agents/skills/` (41 個) | `.claude/skills/` (41 個) |
...
└── .claude/
    ...
    ├── skills/                  ← 操作型知識庫（41 個，部署時從 Shared/ 注入）
    │   ├── _index.md            ← 技能索引
    │   ├── memory-ops/
    │   ├── memory-arch/
    │   ├── code-quality/
