...
- Claude `Agent` 工具可用於唯讀分析與測試驗證；主代理人負責接收並彙整結果，不得把需立即決策的阻塞工作外包。
...
| `[SUDO]` | override/risk-closure request 記錄 | 不跳過 scoped authorization、Team-Native、validation、review、protected gates；不支援 complete 宣稱 |
