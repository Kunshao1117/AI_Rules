...
- **UI Render Guarantee**: The Master Agent MUST render recovered patch packets and evidence packets in the chat interface for Director-visible traceability before integrating physical writes.
