...
- Before applying this workflow, read Shared/workflow-capability-evidence-matrix.md and use the 06 row as the minimum external grounding and evidence contract.
