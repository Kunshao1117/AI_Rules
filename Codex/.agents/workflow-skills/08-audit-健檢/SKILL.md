...
required_skills: [audit-engine, code-audit, ai-dev-quality-gate, quality-review-governance, programming-team-governance, team-task-package, team-role-boundaries, implementation-patch-delivery, memory-coupled-delivery, team-validation-packet, team-review-packet, team-completion-gate]
metadata:
  author: antigravity
  version: "2.0"
  origin: framework
