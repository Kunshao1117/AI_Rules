...
- Open the repair station as GO-backed `formal-write`; any read-only impact, review, regression validation, or memory/docs station remains `formal-readonly` until a separate protected write gate is granted.
