...
- Failed fix loop: after failed validation or repeated repair attempts, use `loop_control.transition_decision` before another attempt; reroute to debug, structured reasoning, or a blocked/unverified state when evidence is insufficient.
