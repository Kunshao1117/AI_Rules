...
> [LOAD SKILL] Read `.Codex/agents/skills/memory-ops/SKILL.md` before proceeding.

- Check MEMORY.md index for cards relevant to target module.
- Load relevant `.Codex/agents/memory/*/SKILL.md` — understand architecture, tracked files, decisions, known issues.
...
> [LOAD SKILL] Read `.Codex/agents/skills/code-quality/SKILL.md` and `.Codex/agents/skills/security-sre/SKILL.md`.
...
> [LOAD SKILL] Re-confirm `.Codex/agents/skills/memory-ops/SKILL.md` is loaded.

- **[NEW] files**: Find or create matching `.Codex/agents/memory/` card. Record file under `## Tracked Files`.
