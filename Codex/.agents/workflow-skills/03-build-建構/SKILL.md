...
> [LOAD SKILL] For coding work, read `.agents/skills/programming-team-governance/SKILL.md`. Build a Programming Team Board; mark stations direct, delegated, blocked, or N/A. Evidence branches stay read-only; the main agent owns writes, review state, and acceptance.
