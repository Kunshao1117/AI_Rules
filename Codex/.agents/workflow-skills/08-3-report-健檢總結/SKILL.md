...
description: "Use when: 健檢第三階段、證據式健康報告、紅黃綠燈號、未驗證/阻塞清單、證據等級摘要、優先修復清單與行動建議。DO NOT use when: 尚未完成前兩階段健檢。"
metadata:
  author: antigravity
  version: "2.0"
  origin: framework
...
> 本工作流彙整 Phase 1 + Phase 2 objects. It uses `audit-engine/references/report-gates.md` for all final status decisions.
