...
- **Reduction boundary**: Reduction may happen only at sub-station task or member-count level. Speed, convenience, cost, small task size, channel friction, or simple-task claims do not justify captain-direct completion for governance, workflow, hook, validation, memory, release, protected-state, or public-contract work.
