...
│   └── YES → Record override/risk-closure request; do not skip security scan or protected gates.
...
├── [SUDO]? → Record override/risk-closure request; do not skip linter/tests, validation, review, or protected gates.
├── Run linter/tests.
