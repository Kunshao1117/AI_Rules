...
Team-Native Core is evaluated before IDE workflow buttons, mode switches, platform tools, adapter prompts, permission prompts, and tool confirmations. Coding, workflow, validation, review, memory, commit, release, handoff, skill-forge, or governance-impact work starts in Team-Native mode.
