...
[EXECUTE] Check whether the build/fix/audit completion report contains review-state blockers, Director risk-closed but not complete (`closed-with-director-risk`) items, or unverified high-risk validation.
