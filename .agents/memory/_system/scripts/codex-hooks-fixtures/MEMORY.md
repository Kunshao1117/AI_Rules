...
- Fixture expectations include 3 advisory allow-reminder cases, 8 allow-reminder outer-agent or single-file cases, and 12 deny cases for direct or unsafe repo-inventory commands.
...
- None yet.
## Evidence Base
- source: Scripts/tests/codex-hooks/fixtures/*.json — Current fixture cases and expected decisions.
