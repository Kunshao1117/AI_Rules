...
last_updated: '2026-07-24T13:40:56+08:00'
status: stable
staleness: 0
...
- Packaging uses `vscode:prepublish` to compile before the existing runtime sentinel verification; VSIX release assets still come from GitHub Release tags and the release workflow.
...
- 封裝會先編譯並執行既有 runtime sentinel 驗證；版本、tag 與 VSIX 發布仍需明確治理。
