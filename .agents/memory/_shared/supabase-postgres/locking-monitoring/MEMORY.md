...
last_updated: '2026-07-03T13:22:02+08:00'
status: stable
staleness: 0
...
- 02: Verified all locking and monitoring tracked reference files exist.
...
- source:Shared/skills/supabase-postgres-best-practices/references/lock-*.md and monitor-*.md — Listed tracked files exist.
