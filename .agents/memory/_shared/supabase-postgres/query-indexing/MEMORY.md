...
last_updated: '2026-07-03T13:22:05+08:00'
status: stable
staleness: 0
...
- 02: Verified all query and indexing tracked reference files exist.
...
- source:Shared/skills/supabase-postgres-best-practices/references/query-*.md and advanced-*.md — Listed tracked files exist.
