...
- Structured reasoning is for complex architecture, debugging, and multi-option analysis; it must invoke the physical MCP tool when the skill is used and must not replace simple direct answers.
