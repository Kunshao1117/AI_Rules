...
> [!CAUTION]
> 🟠 **系統強制攔截**：此記憶已過期失真！
> 追蹤檔案異動：`Antigravity/.agents/workflows/02_blueprint(架構).md`（2026-06-04T03:22:35+08:00）
...
- **Antigravity 記憶卡壓縮治理 (2026-06-04)**: Antigravity README、記憶契約、禁用詞規則與 build/fix/debug/blueprint/condense 工作流已採用 schema v2 記憶語義，要求更新 Current Truth、Active Constraints 與 Cycle Events，並以懶升級處理舊卡。
- **Antigravity 新卡欄位修正 (2026-06-04)**: Blueprint workflow 建立 schema v2 記憶卡時，frontmatter 必須同時包含 schema、語言、cycle、size、line 與 compaction 欄位，避免新卡被工具判成 legacy。
