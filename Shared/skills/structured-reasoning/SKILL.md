...
description: >
  ...
  `loop_control.transition_decision` 升級到 deep reasoning、反覆假設失敗、或需比較多條程式路由時。
...
├── `loop_control.transition_decision` requires deeper reasoning after repeated failed hypotheses → Use
