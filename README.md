...
[![Antigravity](https://img.shields.io/badge/Antigravity-v8.0.2-blue)](Antigravity/README.md)
[![Claude Edition](https://img.shields.io/badge/Claude_Edition-v1.2.2-purple)](Claude/README.md)
[![Codex Edition](https://img.shields.io/badge/Codex_Edition-v0.1.2-orange)](Codex/README.md)
...
AI_Rules 也提供本機 VS Code 延伸模組管理器，適合不想記 PowerShell 指令的日常維護場景。第一版以 `.vsix` 本機安裝為主，也方便分享給朋友；未來可再上架 Marketplace。
...
|------|---------|---------|--------|--------|-----------|---------| 
| **Antigravity** | Gemini（IDE 插件 + CLI） | v8.0.2 | 9 | 20 | 36 | [Antigravity/README.md](Antigravity/README.md) |
| **Claude Edition** | Claude Code（VS Code 插件） | v1.2.2 | 7 | 17 | 36 | [Claude/README.md](Claude/README.md) |
| **Codex Edition** | OpenAI Codex（agentskills.io 標準）| v0.1.2 | 1 | 17 | 36 | [Codex/README.md](Codex/README.md) |
...
| 版本 | 狀態 | 版號 | 更新週期 |
|------|------|------|---------| 
| **Antigravity** | 成熟期 | v8.0.2 | 維護性更新為主，重大功能隨 Gemini IDE 演進 |
| **Claude Edition** | 成長期 | v1.2.2 | 跟隨 Claude Code 插件能力快速迭代 |
| **Codex Edition** | 初始期 | v0.1.2 | agentskills.io 平台標準對齊，技能與 Shared/ 同源更新 |
